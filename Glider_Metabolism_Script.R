...
##### EDIT CODE BELOW #####
setwd("C:\\Users\\sasin\\Sync\\Sasindu\\Trent Metabolism\\Lake Superior\\2014\\NOKOMIS_SEPT3_5")
##### EDIT CODE ABOVE #####
...
##### EDIT CODE BELOW #####
raw.data<-read_csv("nokomis-20140903T1637-delayed_0ba8_ca31_e81b.csv")
##### EDIT CODE ABOVE #####
...
##### EDIT CODE BELOW #####
raw.data<-raw.data%>%
  filter(DateTime >= as.POSIXct("2014-09-04 09:00:00", tz = "GMT"))
...
##### EDIT CODE BELOW #####
Wind<-Wind%>%filter(DateTime >= as.POSIXct("2014-09-04 09:00:00", tz = "GMT"))
##### EDIT CODE ABOVE #####
...
write.csv(input.data, "C:/Users/sasin/Sync/Sasindu/Trent Metabolism/Lake Superior/Outputs/Input tables/input.data_2014_09_03.csv")
...
for(i in unique(input.data$TID)){
  ...
  if(sum(is.na(data$depth))/nrow(data) > 0.8)
  {
    result<-c(i, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA) } else{
      ...
      cdom<-mean(metab.data$cdom, na.rm = T)
...
write.csv(output.table, "C:/Users/sasin/Sync/Sasindu/Trent Metabolism/Lake Superior/Vachan_P_Output/outout_2014_09_03.csv")

write.csv(input.data, "C:/Users/sasin/Sync/Sasindu/Trent Metabolism/Lake Superior/Outputs/input_2014_09_03.csv")
